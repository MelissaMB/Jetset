   ...
   @Override
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/cliente/empresa/**","/oferta/**","/usuario/sistema/create", "/logout","/cliente/natural/**").permitAll()
                .antMatchers("/usuario/**").hasAnyAuthority("Administrador", "DBA")
                .antMatchers("/rol/**").hasAnyAuthority("Administrador", "DBA")
                .antMatchers("/usuario/sistema/list").hasAnyAuthority("Administrador")
                ...
                .antMatchers("/clase/**").hasAnyAuthority("Administrador","AdminVuelo")
                .antMatchers("/precio/**").hasAnyAuthority("Administrador","AdminVuelo")
                .antMatchers("/destino/**").hasAnyAuthority("Administrador","AdminVuelo")
                .antMatchers("/reserva/**").hasAnyAuthority("Administrador","AdminAerolinea", "Pasajero")
